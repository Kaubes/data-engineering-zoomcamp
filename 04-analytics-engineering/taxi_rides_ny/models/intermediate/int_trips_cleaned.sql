...
cleaned_and_enriched as (
    select
        ...
        {{ dbt_utils.generate_surrogate_key(['u.vendor_id', 'u.pickup_datetime', 'u.pickup_location_id', 'u.taxi_type', 'u.dropoff_location_id', 'u.dropoff_datetime']) }} as trip_id,
...
qualify row_number() over(
    partition by vendor_id, pickup_datetime, pickup_location_id, taxi_type, dropoff_location_id, dropoff_datetime
